...
- Update tzf-rs to 2.1.2 and its bundled timezone boundary data.
- Update clap, clap_builder, and clap_derive to 4.6.7.
- Refresh third-party notices for the updated dependency set.
...
[Unreleased]: https://github.com/shoon/takeout-helper-gphotos/compare/v0.1.3...HEAD
[0.1.3]: https://github.com/shoon/takeout-helper-gphotos/compare/v0.1.2...v0.1.3
