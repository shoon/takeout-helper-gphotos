...
fn add_next_fraction_term(term: &u32, convergent: &uR64, previous_convergent: &uR64) -> uR64 {
    return uR64 {
...
fn rational64s_to_f64(fraction: &iR64) -> f64 {
    fraction.nominator as f64 / fraction.denominator as f64
}

fn rational64u_to_f64(fraction: &uR64) -> f64 {
    fraction.nominator as f64 / fraction.denominator as f64
}

fn f64_to_rational64s(real_number: f64) -> iR64 {
...
fn f64_to_rational64u(real_number: f64) -> uR64 {
    ...
    let mut previous_convergent = uR64 {
        nominator: 1u32,
        denominator: 0u32,
    };
    let mut convergent = uR64 {
        nominator: continued_fraction_term as u32,
        denominator: 1u32,
    };
    ...
    let gcd = greatest_common_divisor(best_approximation.nominator, best_approximation.denominator);
...
impl From<f64> for uR64 {
    fn from(val: f64) -> Self {
        f64_to_rational64u(val)
    }
}
impl From<f64> for iR64 {
    fn from(val: f64) -> Self {
        f64_to_rational64s(val)
    }
}

impl From<u32> for uR64 {
    fn from(val: u32) -> Self {
        f64_to_rational64u(val as f64)
    }
}
impl From<u32> for iR64 {
    fn from(val: u32) -> Self {
        f64_to_rational64s(val as f64)
    }
}
impl From<i32> for iR64 {
    fn from(val: i32) -> Self {
        f64_to_rational64s(val as f64)
    }
}

impl From<uR64> for f64 {
    fn from(val: uR64) -> Self {
        rational64u_to_f64(&val)
    }
}
impl From<iR64> for f64 {
    fn from(val: iR64) -> Self {
        rational64s_to_f64(&val)
    }
}

impl From<uR64> for u32 {
    fn from(val: uR64) -> Self {
        rational64u_to_f64(&val) as u32
    }
}
impl From<iR64> for u32 {
    fn from(val: iR64) -> Self {
        rational64s_to_f64(&val) as u32
    }
}
impl From<iR64> for i32 {
    fn from(val: iR64) -> Self {
        rational64s_to_f64(&val) as i32
    }
}
